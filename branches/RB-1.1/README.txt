...
NEWS:
-----
The most important update in this release is the ability to manage
multiple image- and/or videodates per set. 
 ...
 * Make sure the user running the web server has write-access to the 
CandyDollDB root directory.
...
WWW:	http://code.google.com/p/candydolldb/
