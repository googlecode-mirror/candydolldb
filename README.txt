...
NEWS:
-----
The new lay-out has been refined and extended by thumbnails on the
index page, better cache-image handling, including a delete-on-overlay
feature.

We welcome MrAnimosityFish to the team of CandyDollDB developers!
He has contributed some new features and bugfixes in this release.
Among those are the improved dirty-sets handling, filtering and clean-up.
We hope to see more where those came from. :-)
